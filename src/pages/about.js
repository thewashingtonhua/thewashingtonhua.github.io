  ...
  <Layout>
    ...
    <div className='mf-content' id='about'>
      <article>
        ...
        <p>JavaScript 开发者一枚<span id='experience'></span></p>
        ...
        <h1>顺便招人</h1>
        <p><a target='_blank' href='https://www.inex.exchange'>INEX</a> 招募前端开发工程师（坐标上海虹口）</p>
        <p>我们提供：</p>
        <ul>
          <li>不低于行业主流水平的薪资（具体多少您自己谈）</li>
          <li>略高于行业标配的福利待遇（全 Mac 环境、开放式办公、加班补贴、零食下午茶、逗比但靠谱的同事、漂亮还单身的小姐姐……）</li>
